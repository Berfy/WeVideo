...
public class SunLayout extends FrameLayout implements MaterialHeadListener {
    ...
    private static final int DEFAULT_SUN_COLOR = 0;
    ...
    private static final int DEFAULT_LINE_COLOR = 0;
    ...
    private void init() {
        ...
        mSunColor = DEFAULT_SUN_COLOR == 0 ? getResources().getColor(R.color.main_green) : DEFAULT_SUN_COLOR;
        mEyesSize = DEFAULT_SUN_EYES_SIZE;
        mLineColor = DEFAULT_LINE_COLOR == 0 ? getResources().getColor(R.color.main_green) : DEFAULT_LINE_COLOR;
